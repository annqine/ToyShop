...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqgrid/5.8.8/css/ui.jqgrid.min.css" integrity="sha512-32LPQp8XpFZLhafWO1i/8MvAFIVzDCqJ1C1blA1FjbW210TWwe6olae8lIkZHFwJU1oaR481MDX4clGpGKZigg==" crossorigin="anonymous" referrerpolicy="no-referrer" />


    <script src="https://cdnjs.cloudflare.com/ajax/libs/jqgrid/5.8.8/js/jquery.jqGrid.min.js" integrity="sha512-nmlwuvfrdYvdx/9swS+xg7W5nTXeGLCETjPHuTPhOHynSsOGjIQ30TM539VbdPi+JzO8jvoEc2icbAIZ78Jfxw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jqgrid/5.8.8/js/i18n/grid.locale-ru.min.js" integrity="sha512-jQT+Yi1ouqHnLk+dwT3ytOlneHR2Vjt7FtOBiEhdw287z3ASC650pFY5+6NDujtdB9+129H14nmsF2x13hNJew==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
</head>
    ...
    <script>
        $(document).ready(function () {
            $('#toysTable').jqGrid({
                ...
                mtype: 'GET',
                autowidth: true,
                colNames: ['ID', 'Название', 'Цена', 'Фото'],
                colModel: [
